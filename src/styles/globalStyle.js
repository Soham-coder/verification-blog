...
const GlobalStyle = createGlobalStyle`
  :root {
    ...
    --device-xs-max-width: 719px;
    --device-sm-max-width: 1067px;
    --device-md-max-width: 4023px;
    --device-lg-max-width: 4441px;

    --device-xs-max-width-query: (max-width: 719px);
    --device-sm-max-width-query: (max-width: 1067px);
    --device-md-max-width-query: (max-width: 4023px);
    --device-lg-max-width-query: (max-width: 4441px);
